...
if __name__ == "__main__":
    # getCircle(0.01, 0.02, 10, 0, 0, 0)
    zero = np.array([[0], [0], [0]])
    # planner = MinimumTrajPlanner(getLine(20, 1, 0.1, 0, 0, 0, 'x')[:3], 0.5, 0.1, zero, zero, zero, zero, 3)
    planner = MinimumTrajPlanner(getCircle(0.01, 0.02, 10, 0, 0, 0)[:3], 0.5, 0.1, zero, zero, zero, zero, 3)
    print(planner.computeTraj())
